...
Requirements:
- Archipelago 0.6.3 (later versions not tested)
- Manual Client
...
- Always use the YAMLs provided in this Github repo, the ones made by the APlauncher do not have descriptions for all the settings because I don't know how to do that
